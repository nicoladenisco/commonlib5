 ...
 * Quando il processo produce output viene inviato a console.<br>
 * Stdout del processo inviato a stdout.<br>
 * Stderr del processo inviato a stderr.<br>
 *
 * @author Nicola De Nisco
 */
public class ProcessWatchStdout
{
  public static int watch(Process process, boolean killOnExit, String encoding)
     throws IOException
  {
    ...
    while(!done)
    {
      ...
      if(!stdoutclosed && stdout.available() > 0)
      {
        ...
        if(read < 0)
          ...
          System.out.print(new String(buffer, encoding));
      }
      ...
      if(!stderrclosed && stderr.available() > 0)
      {
        ...
        if(read < 0)
          ...
          System.err.print(new String(buffer, encoding));
      }
